...
echo "\033[34;1m"
echo "\033[32;1mauthor: BarrierJR"
echo "\033[33;1mTeam: Cyber Er0r Team"
echo "\033[34;1mIndonesia Security Lite"
echo "\033[32;1mIndonesian Cyber"
echo ""
echo ""
echo "\033[32;1m[01].Deface Webdav"
echo "\033[33;1m[02].EXIT"
read -p "[========>" ganteng
echo ""
echo ""
sleep 1
if [ $ganteng = 01 ] || [ $ganteng = 1 ]
then
...
if [ $ganteng = 02 ] || [ $ganteng = 2 ]
then
echo "\033[32;1mWe Are Family CYBER ER0R TEAM"
sleep 1
